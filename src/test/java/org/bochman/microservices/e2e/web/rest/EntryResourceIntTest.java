package org.bochman.microservices.e2e.web.rest;

import org.bochman.microservices.e2e.MicroServicesE2EApp;

import org.bochman.microservices.e2e.domain.Entry;
import org.bochman.microservices.e2e.repository.EntryRepository;
import org.bochman.microservices.e2e.repository.search.EntrySearchRepository;
import org.bochman.microservices.e2e.web.rest.errors.ExceptionTranslator;
...
import static org.bochman.microservices.e2e.web.rest.TestUtil.sameInstant;
import static org.bochman.microservices.e2e.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = MicroServicesE2EApp.class)
public class EntryResourceIntTest {
    ...
    /**
     * This repository is mocked in the org.bochman.microservices.e2e.repository.search test package.
     *
     * @see org.bochman.microservices.e2e.repository.search.EntrySearchRepositoryMockConfiguration
     */
    @Autowired
