...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MicroServicesE2E");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MicroServicesE2E");
        ...
        config.getMapConfigs().put("org.bochman.microservices.e2e.domain.*", initializeDomainMapConfig(jHipsterProperties));
